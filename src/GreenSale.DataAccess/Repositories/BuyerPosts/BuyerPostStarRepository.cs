    ...
    public class BuyerPostStarRepository : BaseRepository, IBuyerPostStarRepository
    {
        ...
        public async Task<int> DeleteAsync(long Id)
        {
            try
            {
                ...
                string query = $"DELETE FROM public.buyerpoststars WHERE id = @ID;";
        ...
        public async Task<List<long>> GetAllStarsPostIdCountAsync(long postid)
        {
            try
            {
                await _connection.OpenAsync();
                ...
                var result = (await _connection.QueryAsync<long>(query, new { Id = postid })).ToList();
